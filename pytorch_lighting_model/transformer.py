...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask, layer_norm_first=False):
        """
...
class EncoderLayer(nn.Module):
    def __init__(self):
        ...
        self.layNorm = nn.LayerNorm(d_model)
    ...
    def forward(self, enc_inputs, enc_self_attn_mask):
        ...
        # enc_input = self.layNorm(enc_inputs)
...
class ContactMap(nn.Module):
    def __init__(self):
        ...
        # self.decoder = Decoder().to(device)
        self.projection = nn.Linear(d_model, 3, bias=False)
        # self.

    def forward(self, enc_inputs):
        # print("")
        enc_outputs, enc_self_attns = self.Transformer(enc_inputs)
